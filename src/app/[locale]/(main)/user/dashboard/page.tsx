      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6">
            ...
            <LocalizedClientLink
              href="/user/rewards"
              className="mt-4 block w-full text-center px-4 py-2 bg-cookies-yellow hover:bg-cookies-light-yellow text-black font-bold rounded-lg transition-colors"
            >
              Redeem Rewards
            </LocalizedClientLink>
          </div>
            ...
            {nextTierInfo.tier ? (
              <>
                <div className="flex items-end justify-between mb-3">
                  <div>
                    <p className="text-4xl font-barlow font-black text-cookies-yellow">
                ...
                <div className="w-full bg-zinc-700 rounded-full h-3">
                  <div
                    className="bg-gradient-to-r from-cookies-yellow to-cookies-light-yellow h-3 rounded-full transition-all duration-500"
                    style={{
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <LocalizedClientLink href="/user/orders">
            <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6 hover:border-cookies-yellow transition-all duration-300 cursor-pointer group">
              <div className="flex items-center justify-between mb-4">
                <div className="p-3 bg-cookies-yellow/10 rounded-lg">
                  <svg className="w-6 h-6 text-cookies-yellow" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4" />
                  </svg>
                </div>
                <span className="text-3xl font-barlow font-black text-white group-hover:text-cookies-yellow transition-colors">
                  {activeOrders.length}
                </span>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-zinc-800 border border-zinc-700 rounded-lg p-6">
            <div className="flex items-center justify-between mb-6">
              ...
              <LocalizedClientLink href="/user/orders" className="text-cookies-yellow hover:text-cookies-light-yellow text-sm font-bold">
                View All →
              </LocalizedClientLink>
            </div>
            ...
            {recentOrders.length > 0 ? (
              <div className="space-y-4">
                {recentOrders.map((order: any) => (
                  <LocalizedClientLink
                    ...
                    className="block"
                  >
                    <div className="bg-zinc-900 border border-zinc-700 rounded-lg p-4 hover:border-cookies-yellow transition-all duration-300">
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-white font-bold text-sm">Order #{order.display_id}</span>
                        <span className={`px-2 py-1 rounded text-xs font-bold ${
                          order.fulfillment_status === 'fulfilled'
                            ? 'bg-cookies-yellow/20 text-cookies-yellow'
              ...
              <div className="text-center py-12">
                ...
                <LocalizedClientLink href="/categories" className="inline-block mt-4 px-6 py-2 bg-cookies-yellow text-black font-bold rounded-full hover:bg-cookies-light-yellow transition-colors">
                  Start Shopping
                </LocalizedClientLink>
              </div>
            )}
          ...
          <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6">
            ...
            <div className="space-y-3">
              <LocalizedClientLink href="/categories">
                <button className="w-full flex items-center gap-3 bg-cookies-yellow hover:bg-cookies-light-yellow text-black font-barlow font-bold py-3 px-4 rounded-lg transition-all duration-300">
              ...
              <LocalizedClientLink href="/user/orders">
                <button className="w-full flex items-center gap-3 bg-zinc-900 hover:bg-zinc-700 text-white font-barlow font-bold py-3 px-4 rounded-lg border border-zinc-700 hover:border-cookies-yellow transition-all duration-300">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-8 bg-zinc-800 border border-zinc-700 rounded-lg p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <LocalizedClientLink href="/user/rewards" className="text-cookies-yellow hover:text-cookies-light-yellow text-sm font-bold">
              View All →
            </LocalizedClientLink>
          </div>
